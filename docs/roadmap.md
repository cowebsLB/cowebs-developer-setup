...
| Ubuntu/Fedora adapter | Ubuntu full x64 core planning; Fedora adapter foundation | Typed prerequisites are dry-run-only; no Linux broker or Unix bootstrap yet |
