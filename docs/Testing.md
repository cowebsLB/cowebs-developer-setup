...
- deterministic v2-to-v3 compilation with exact preservation of all 86 packages, 34 packs, nine profiles, Windows mappings, dependencies, conflicts, configuration intents, options, and estimates plus all 86 reviewed Ubuntu classifications, 54 executable providers, 32 unsupported results, and ten signed-repository prerequisites;
